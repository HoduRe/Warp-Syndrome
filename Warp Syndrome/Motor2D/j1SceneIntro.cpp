...
{
	UI* element;
	element = App->gui->AddUIElement(new Button(150, 50));
	element->listeners.PushBack(App->scene);
	element = App->gui->AddUIElement(new Scrollbar(200, 250, 50));
	element->listeners.PushBack(App->scene);
	element = App->gui->AddUIElement(new Static_Text(200, 200, "Hola Mundo"));
	element->listeners.PushBack(App->scene);
	element = App->gui->AddUIElement(new Editable_Text(400, 200, 200));
	element->listeners.PushBack(App->scene);
